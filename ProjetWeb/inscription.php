            ...
            <form method="post" action="">
                ...
                <div class="inputForm">
                    <svg height="20" viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            d="m192 448c-26.476562 0-48-21.523438-48-48 0-26.453125 21.523438-48 48-48s48 21.546875 48 48c0 26.476562-21.523438 48-48 48zm0-80c-17.648438 0-32 14.351562-32 32s14.351562 32 32 32 32-14.351562 32-32-14.351562-32-32-32zm0 0">
                        </path>
                        <path
                            d="m304 224h-224v-128c0-53.023438 42.976562-96 96-96s96 42.976562 96 96v64c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-64c0-35.289062-28.710938-64-64-64s-64 28.710938-64 64v128h192c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0">
                        </path>
                    </svg>
                ...
                <div class="inputForm">
                    ...
                    <input type="password" class="input" name="confirm_password" placeholder="Entrer votre mot de passe"
                        required>
                </div>
                <div class="flex-column">
                    <label>Nom : </label>
                ...
                <div class="inputForm">
                    <svg height="20" viewBox="0 0 32 32" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m18.517 15.576v-.023c.449-1.012.751-2.452.805-3.805h.013v-1.761c0-1.225-.342-2.39-.93-3.391.56-.518.9-1.254.9-2.096 0-1.612-1.31-2.923-2.922-2.923-.647 0-1.239.216-1.716.575-.477-.359-1.068-.575-1.715-.575-1.613 0-2.924 1.311-2.924 2.923 0 .842.34 1.578.9 2.096-.588 1.001-.93 2.166-.93 3.391v1.761h.013c.054 1.353.356 2.793.805 3.805 0 0 .05.09.071.132-.019.016-.044.028-.063.046-2.76 2.291-4.291 5.768-4.291 9.601v2.702c0 .249.201.451.451.451h15.5c.25 0 .451-.202.451-.451v-2.702c0-3.832-1.531-7.31-4.29-9.601-.02-.018-.045-.03-.064-.046.021-.042.071-.132.071-.132zm-4.428-2.302v.002-.002zm0-10.015c.61 0 1.106.497 1.106 1.106s-.497 1.105-1.106 1.105-1.105-.497-1.105-1.105.496-1.106 1.105-1.106zm-1.188 5.298c.342.031.794.059 1.188.059.393 0 .845-.028 1.188-.059v.74c0 1.179-.318 2.503-.805 3.553-.014.032-.031.065-.042.098-.011-.033-.029-.066-.043-.098-.487-1.05-.805-2.374-.805-3.553zm6.017 18.444h-14.5v-2.25c0-4.2 2.5-8 6.25-9.75.728 1.15 1.5 1.5 2.25 1.5s1.522-.35 2.25-1.5c3.75 1.75 6.25 5.55 6.25 9.75zm-1.455-21.63c-.609 0-1.105-.496-1.105-1.105s.496-1.106 1.105-1.106 1.105.497 1.105 1.106-.497 1.105-1.105 1.105zm0 0" />
                    </svg>
                ...
                <div class="inputForm">
                    <svg height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="m17.62 19.43c-3.45 0-7.97-4.1-9.27-7.18 1.2-2.4.9-4.8-.3-6-.3-.3-.6-.6-1.5-.3-1.5.6-2.4.9-3 1.5 0 1.8 1.2 3.9 2.7 6 2.1 3 4.5 5.4 7.5 7.2 1.8 1.2 4.2 2.7 6 2.7.6-.6.9-1.5 1.5-3 .3-.9 0-1.2-.3-1.5-1.5-1.2-3.6-1.5-6-.3-2.7-1.8-4.8-3-6-4.5-.3-.3-.6-.9-1.5-.9zm0-17.43c-5.4 0-9.9 4.5-9.9 9.9s4.5 9.9 9.9 9.9 9.9-4.5 9.9-9.9-4.5-9.9-9.9-9.9zm0 18c-4.5 0-8.1-3.6-8.1-8.1s3.6-8.1 8.1-8.1 8.1 3.6 8.1 8.1-3.6 8.1-8.1 8.1z" />
                    </svg>
                    <input type="tel" class="input" name="phone" placeholder="Entrer votre numéro de téléphone"
                        required>
                </div>
